...
| Champ                  | Valeur                                     |
| ---------------------- | ------------------------------------------ |
| **Raison sociale**     | _(à compléter)_                            |
...
| Logiciels desktop isolés              | pas de multi-tenant                           |
...
> et déclarations CNSS., pas de multi-tenant, mise à jour manuelle.
...
> _"Établir les fondations sécurisées de la plateforme : permettre à une société
...
- _Relations :_ `<<include>>` Authentification — `<<include>>` Système d'audit
...
> _"Permettre à l'équipe RH de gérer l'intégralité du dossier administratif d'un
> employé — de son recrutement à la formalisation de sa relation contractuelle."_
...
> _"Mettre en place le moteur de calcul de paie conforme à la Loi de Finances 2026
> et gérer les temps : congés, absences, primes et avances sur salaire."_
...
> _"Déployer PaieBot (assistant IA local), garantir la conformité réglementaire
> complète et assurer l'intégration comptable avec export SAGE."_
...
## _"De la feuille Excel à la plateforme SaaS IA — la paie tunisienne réinventée."_
...
_ISET Mahdia — 2025-2026_

---

> _"Nous sommes à votre disposition pour toute question."_
