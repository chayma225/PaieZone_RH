...
Les 8 écrans non livrés (Tenants, Regulatory, Admin Company, Admin Users, Admin Audit, RH Structure, RH Payroll, RH Finances, RH Leaves, Emp Leaves, Emp Requests) suivent **exactement le même pattern** que les 4 écrans fournis :
