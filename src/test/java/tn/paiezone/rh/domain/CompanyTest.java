...
class CompanyTest {
    ...
    void companySubscriptionTest() {
        ...
        company.setCompanySubscription(companySubscriptionBack);
        assertThat(company.getCompanySubscription()).isEqualTo(companySubscriptionBack);

        company.companySubscription(null);
        assertThat(company.getCompanySubscription()).isNull();
    }
}
