...
public class ChatMessageAsserts {
    ...
    public static void assertChatMessageUpdatableFieldsEquals(ChatMessage expected, ChatMessage actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getTokenUsed()).as("check tokenUsed").isEqualTo(expected.getTokenUsed()))
            .satisfies(a -> assertThat(a.getSentAt()).as("check sentAt").isEqualTo(expected.getSentAt()))
            .satisfies(a -> assertThat(a.getErrorOccurred()).as("check errorOccurred").isEqualTo(expected.getErrorOccurred()));
    }
