...
import static tn.paiezone.rh.domain.CompanyAsserts.*;
...
class CompanyResourceIT {
    ...
    private static final String DEFAULT_CNSS_ID = "AAAAAAAAAA";
    private static final String UPDATED_CNSS_ID = "BBBBBBBBBB";
    ...
    private static final LocalDate DEFAULT_TRIAL_END = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_TRIAL_END = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Company createUpdatedEntity() {
        return new Company()
            ...
            .tenantSchema(UPDATED_TENANT_SCHEMA)
            .active(UPDATED_ACTIVE)
            .trialEnd(UPDATED_TRIAL_END)
    ...
    @Test
    @Transactional
    void checkTenantSchemaIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        company.setTenantSchema(null);
    ...
    void getAllCompanies() throws Exception {
        ...
        restCompanyMockMvc
            ...
            .andExpect(jsonPath("$.[*].cnssId").value(hasItem(DEFAULT_CNSS_ID)))
            ...
            .andExpect(jsonPath("$.[*].tenantSchema").value(hasItem(DEFAULT_TENANT_SCHEMA)))
            .andExpect(jsonPath("$.[*].active").value(hasItem(DEFAULT_ACTIVE)))
            .andExpect(jsonPath("$.[*].trialEnd").value(hasItem(DEFAULT_TRIAL_END.toString())))
    ...
    void getCompany() throws Exception {
        ...
        restCompanyMockMvc
            ...
            .andExpect(jsonPath("$.cnssId").value(DEFAULT_CNSS_ID))
            ...
            .andExpect(jsonPath("$.tenantSchema").value(DEFAULT_TENANT_SCHEMA))
            .andExpect(jsonPath("$.active").value(DEFAULT_ACTIVE))
            .andExpect(jsonPath("$.trialEnd").value(DEFAULT_TRIAL_END.toString()))
