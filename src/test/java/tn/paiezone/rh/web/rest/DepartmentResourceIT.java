...
import static tn.paiezone.rh.domain.DepartmentAsserts.*;
...
class DepartmentResourceIT {
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        ...
        updatedDepartment.setCompany(company);
    ...
    void putExistingDepartment() throws Exception {
        ...
        updatedDepartment.code(UPDATED_CODE).name(UPDATED_NAME).description(UPDATED_DESCRIPTION).active(UPDATED_ACTIVE);
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.name(UPDATED_NAME).active(UPDATED_ACTIVE);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.code(UPDATED_CODE).name(UPDATED_NAME).description(UPDATED_DESCRIPTION).active(UPDATED_ACTIVE);
