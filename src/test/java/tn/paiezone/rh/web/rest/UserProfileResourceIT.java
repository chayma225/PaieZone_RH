...
import static tn.paiezone.rh.domain.UserProfileAsserts.*;
...
class UserProfileResourceIT {
    ...
    private static final AppRole DEFAULT_ROLE = AppRole.SUPER_ADMIN;
    private static final AppRole UPDATED_ROLE = AppRole.ADMIN;
    ...
    public static UserProfile createUpdatedEntity(EntityManager em) {
        ...
        updatedUserProfile.setCompany(company);
    ...
    @Test
    @Transactional
    void checkJhiUserIdIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        userProfile.setJhiUserId(null);
    ...
    void getAllUserProfiles() throws Exception {
        ...
        restUserProfileMockMvc
            ...
            .andExpect(jsonPath("$.[*].twoFactorEnabled").value(hasItem(DEFAULT_TWO_FACTOR_ENABLED)))
    ...
    void getUserProfile() throws Exception {
        ...
        restUserProfileMockMvc
            ...
            .andExpect(jsonPath("$.jhiUserId").value(DEFAULT_JHI_USER_ID))
            ...
            .andExpect(jsonPath("$.twoFactorEnabled").value(DEFAULT_TWO_FACTOR_ENABLED))
    ...
    void partialUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.locale(UPDATED_LOCALE);
