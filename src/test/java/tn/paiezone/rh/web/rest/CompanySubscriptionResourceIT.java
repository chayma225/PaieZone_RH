...
class CompanySubscriptionResourceIT {
    ...
    private static final CompanySubscriptionStatus DEFAULT_STATUS = CompanySubscriptionStatus.TRIAL;
    private static final CompanySubscriptionStatus UPDATED_STATUS = CompanySubscriptionStatus.ACTIVE;
