package tn.paiezone.rh.config.timezone;
...
import tn.paiezone.rh.repository.timezone.DateTimeWrapper;
import tn.paiezone.rh.repository.timezone.DateTimeWrapperRepository;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM pz_date_time_wrapper where id=%d", fieldName, id);
    }
