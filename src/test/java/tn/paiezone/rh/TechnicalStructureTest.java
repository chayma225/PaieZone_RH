...
@AnalyzeClasses(packagesOf = PaieZoneRhApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(alwaysTrue(), belongToAnyOf(
            tn.paiezone.rh.config.Constants.class,
            tn.paiezone.rh.config.ApplicationProperties.class
        ));
}
