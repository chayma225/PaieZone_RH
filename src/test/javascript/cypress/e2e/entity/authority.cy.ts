...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '976fe786-2d21-43d1-a3a8-0f7c5db8958e' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('c0b15864-2dbf-4218-a63b-78ffa66e9245');
      cy.get(`[data-cy="name"]`).should('have.value', 'c0b15864-2dbf-4218-a63b-78ffa66e9245');
