...
describe('Authority e2e test', () => {
  ...
  let username: string;
  let password: string;
  const authoritySample = { name: '940467b3-5085-42aa-bdcd-3885502bb041' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('6cf83958-692f-4202-b7f8-48019d0a69b6');
      cy.get(`[data-cy="name"]`).should('have.value', '6cf83958-692f-4202-b7f8-48019d0a69b6');
