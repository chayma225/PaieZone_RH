...
describe('JobPosition Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a JobPosition', () => {
      ...
      service.create(jobPosition).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a JobPosition', () => {
      ...
      service.update(jobPosition).subscribe(resp => (expectedResult = resp));
    ...
    describe('addJobPositionToCollectionIfMissing', () => {
      it('should add a JobPosition to an empty array', () => {
        ...
        expect(expectedResult).toEqual([jobPosition]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([jobPosition, jobPosition2]);
      });
