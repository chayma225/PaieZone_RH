...
import { TaxBracketDeleteDialog } from './tax-bracket-delete-dialog';

describe('TaxBracket Management Delete Component', () => {
  let comp: TaxBracketDeleteDialog;
  let fixture: ComponentFixture<TaxBracketDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TaxBracketDeleteDialog);
