...
import { AccountPlanDeleteDialog } from './account-plan-delete-dialog';

describe('AccountPlan Management Delete Component', () => {
  let comp: AccountPlanDeleteDialog;
  let fixture: ComponentFixture<AccountPlanDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AccountPlanDeleteDialog);
