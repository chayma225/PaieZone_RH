...
describe('AccountPlan Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [AccountPlanUpdateComponent],
      providers: [
        provideHttpClient(),
        FormBuilder,
        {
  ...
  describe('save', () => {
    it('should call update service on save for existing entity', () => {
      // GIVEN
      const saveSubject = new Subject<HttpResponse<IAccountPlan>>();
      const accountPlan = { id: 7481 };
      jest.spyOn(accountPlanFormService, 'getAccountPlan').mockReturnValue(accountPlan);
    ...
    it('should call create service on save for new entity', () => {
      ...
      const saveSubject = new Subject<HttpResponse<IAccountPlan>>();
      const accountPlan = { id: 7481 };
      jest.spyOn(accountPlanFormService, 'getAccountPlan').mockReturnValue({ id: null });
