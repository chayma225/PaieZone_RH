...
describe('LeaveType Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a LeaveType', () => {
      ...
      service.create(leaveType).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a LeaveType', () => {
      ...
      service.update(leaveType).subscribe(resp => (expectedResult = resp));
    ...
    describe('addLeaveTypeToCollectionIfMissing', () => {
      it('should add a LeaveType to an empty array', () => {
        ...
        expect(expectedResult).toEqual([leaveType]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([leaveType, leaveType2]);
      });
