...
import { LeaveBalanceDeleteDialog } from './leave-balance-delete-dialog';

describe('LeaveBalance Management Delete Component', () => {
  let comp: LeaveBalanceDeleteDialog;
  let fixture: ComponentFixture<LeaveBalanceDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LeaveBalanceDeleteDialog);
