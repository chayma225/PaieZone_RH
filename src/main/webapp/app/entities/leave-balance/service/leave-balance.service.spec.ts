...
describe('LeaveBalance Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a LeaveBalance', () => {
      ...
      service.create(leaveBalance).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a LeaveBalance', () => {
      ...
      service.update(leaveBalance).subscribe(resp => (expectedResult = resp));
    ...
    describe('addLeaveBalanceToCollectionIfMissing', () => {
      it('should add a LeaveBalance to an empty array', () => {
        ...
        expect(expectedResult).toEqual([leaveBalance]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([leaveBalance, leaveBalance2]);
      });
