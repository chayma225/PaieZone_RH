...
import { RubriqueDeleteDialog } from './rubrique-delete-dialog';

describe('Rubrique Management Delete Component', () => {
  let comp: RubriqueDeleteDialog;
  let fixture: ComponentFixture<RubriqueDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RubriqueDeleteDialog);
