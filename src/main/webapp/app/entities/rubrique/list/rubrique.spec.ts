...
import { sampleWithRequiredData } from '../rubrique.test-samples';
...
describe('Rubrique Management Component', () => {
  ...
  let comp: Rubrique;
  let fixture: ComponentFixture<Rubrique>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(Rubrique);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 18175 }], { headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' } });
    await vitest.runAllTimersAsync();

    // THEN
    expect(comp.isLoading()).toEqual(false);
    expect(comp.rubriques()[0]).toEqual(expect.objectContaining({ id: 18175 }));
  });

  describe('trackId', () => {
    it('should forward to rubriqueService', () => {
      const entity = { id: 18175 };
      vitest.spyOn(service, 'getRubriqueIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.rubriquesParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
