...
import { AdvanceService, EntityArrayResponseType } from '../service/advance.service';
...
export class AdvanceComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.advances.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IAdvance[] | null): IAdvance[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.advanceService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
