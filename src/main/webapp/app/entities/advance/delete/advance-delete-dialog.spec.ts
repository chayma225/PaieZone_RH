...
import { AdvanceDeleteDialog } from './advance-delete-dialog';

describe('Advance Management Delete Component', () => {
  let comp: AdvanceDeleteDialog;
  let fixture: ComponentFixture<AdvanceDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AdvanceDeleteDialog);
