...
describe('EmployeeHistory Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a EmployeeHistory', () => {
      ...
      service.create(employeeHistory).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a EmployeeHistory', () => {
      ...
      service.update(employeeHistory).subscribe(resp => (expectedResult = resp));
    ...
    describe('addEmployeeHistoryToCollectionIfMissing', () => {
      it('should add a EmployeeHistory to an empty array', () => {
        ...
        expect(expectedResult).toEqual([employeeHistory]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([employeeHistory, employeeHistory2]);
      });
