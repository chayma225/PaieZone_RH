...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../leave-request.test-samples';
...
describe('LeaveRequest Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a LeaveRequest', () => {
      ...
      service.create(leaveRequest).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a LeaveRequest', () => {
      ...
      service.update(leaveRequest).subscribe(resp => (expectedResult = resp));
    ...
    describe('addLeaveRequestToCollectionIfMissing', () => {
      it('should add a LeaveRequest to an empty array', () => {
        ...
        expect(expectedResult).toEqual([leaveRequest]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([leaveRequest, leaveRequest2]);
      });
