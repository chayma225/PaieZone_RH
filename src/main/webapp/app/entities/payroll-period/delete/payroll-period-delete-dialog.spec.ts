...
import { PayrollPeriodDeleteDialog } from './payroll-period-delete-dialog';

describe('PayrollPeriod Management Delete Component', () => {
  let comp: PayrollPeriodDeleteDialog;
  let fixture: ComponentFixture<PayrollPeriodDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PayrollPeriodDeleteDialog);
