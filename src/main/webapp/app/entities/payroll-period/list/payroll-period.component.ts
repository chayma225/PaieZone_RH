...
import { EntityArrayResponseType, PayrollPeriodService } from '../service/payroll-period.service';
import { PayrollPeriodDeleteDialogComponent } from '../delete/payroll-period-delete-dialog.component';
...
export class PayrollPeriodComponent implements OnInit {
  ...
  payrollPeriods = signal<IPayrollPeriod[]>([]);
  isLoading = false;
  ...
  delete(payrollPeriod: IPayrollPeriod): void {
    const modalRef = this.modalService.open(PayrollPeriodDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.payrollPeriods.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IPayrollPeriod[] | null): IPayrollPeriod[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.payrollPeriodService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
