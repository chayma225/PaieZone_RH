...
import { PayrollPeriodDetail } from './payroll-period-detail';

describe('PayrollPeriod Management Detail Component', () => {
  let comp: PayrollPeriodDetail;
  let fixture: ComponentFixture<PayrollPeriodDetail>;
      ...
      providers: [
        provideRouter(
          [
            {
              path: '**',
              loadComponent: () => import('./payroll-period-detail').then(m => m.PayrollPeriodDetail),
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PayrollPeriodDetail);
  ...
  describe('OnInit', () => {
    it('should load payrollPeriod on init', async () => {
      ...
      const instance = await harness.navigateByUrl('/', PayrollPeriodDetail);
