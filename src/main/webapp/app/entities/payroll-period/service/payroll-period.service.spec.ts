...
describe('PayrollPeriod Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a PayrollPeriod', () => {
      ...
      service.create(payrollPeriod).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a PayrollPeriod', () => {
      ...
      service.update(payrollPeriod).subscribe(resp => (expectedResult = resp));
    ...
    describe('addPayrollPeriodToCollectionIfMissing', () => {
      it('should add a PayrollPeriod to an empty array', () => {
        ...
        expect(expectedResult).toEqual([payrollPeriod]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([payrollPeriod, payrollPeriod2]);
      });
