...
import { OfficialDocumentDeleteDialog } from './official-document-delete-dialog';

describe('OfficialDocument Management Delete Component', () => {
  let comp: OfficialDocumentDeleteDialog;
  let fixture: ComponentFixture<OfficialDocumentDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(OfficialDocumentDeleteDialog);
