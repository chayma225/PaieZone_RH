...
describe('OfficialDocument Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a OfficialDocument', () => {
      ...
      service.create(officialDocument).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a OfficialDocument', () => {
      ...
      service.update(officialDocument).subscribe(resp => (expectedResult = resp));
    ...
    describe('addOfficialDocumentToCollectionIfMissing', () => {
      it('should add a OfficialDocument to an empty array', () => {
        ...
        expect(expectedResult).toEqual([officialDocument]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([officialDocument, officialDocument2]);
      });
