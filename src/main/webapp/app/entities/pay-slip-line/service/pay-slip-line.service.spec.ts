...
describe('PaySlipLine Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a PaySlipLine', () => {
      ...
      service.create(paySlipLine).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a PaySlipLine', () => {
      ...
      service.update(paySlipLine).subscribe(resp => (expectedResult = resp));
    ...
    describe('addPaySlipLineToCollectionIfMissing', () => {
      it('should add a PaySlipLine to an empty array', () => {
        ...
        expect(expectedResult).toEqual([paySlipLine]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([paySlipLine, paySlipLine2]);
      });
