...
import { PaySlipLineDeleteDialog } from './pay-slip-line-delete-dialog';

describe('PaySlipLine Management Delete Component', () => {
  let comp: PaySlipLineDeleteDialog;
  let fixture: ComponentFixture<PaySlipLineDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PaySlipLineDeleteDialog);
