...
import publicHolidayResolve from './public-holiday-routing-resolve.service';

describe('PublicHoliday routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: PublicHolidayService;
  let resultPublicHoliday: IPublicHoliday | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IPublicHoliday returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        publicHolidayResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultPublicHoliday).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IPublicHoliday>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
