...
import { RegulatoryParamDeleteDialog } from './regulatory-param-delete-dialog';

describe('RegulatoryParam Management Delete Component', () => {
  let comp: RegulatoryParamDeleteDialog;
  let fixture: ComponentFixture<RegulatoryParamDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RegulatoryParamDeleteDialog);
