...
describe('HrDocument Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a HrDocument', () => {
      ...
      service.create(hrDocument).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a HrDocument', () => {
      ...
      service.update(hrDocument).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addHrDocumentToCollectionIfMissing', () => {
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(hrDocument);
        expect(expectedResult).toContain(hrDocument2);
      });
