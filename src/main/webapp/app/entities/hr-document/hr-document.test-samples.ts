...
export const sampleWithRequiredData: IHrDocument = {
  ...
  fileUrl: 'tromper',
  uploadedAt: dayjs('2026-03-30T23:51'),
  active: false,
};
...
export const sampleWithPartialData: IHrDocument = {
  ...
  fileSize: 14498,
  uploadedAt: dayjs('2026-03-31T17:10'),
  expiryDate: dayjs('2026-03-31'),
  active: true,
};
...
export const sampleWithFullData: IHrDocument = {
  ...
  fileSize: 12639,
  mimeType: 'quoique',
  uploadedAt: dayjs('2026-03-30T20:24'),
  expiryDate: dayjs('2026-03-30'),
  active: true,
};
...
export const sampleWithNewData: NewHrDocument = {
  ...
  uploadedAt: dayjs('2026-03-31T07:23'),
  active: true,
  id: null,
};
