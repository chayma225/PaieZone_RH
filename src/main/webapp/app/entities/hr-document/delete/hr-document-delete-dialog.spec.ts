...
import { HrDocumentDeleteDialog } from './hr-document-delete-dialog';

describe('HrDocument Management Delete Component', () => {
  let comp: HrDocumentDeleteDialog;
  let fixture: ComponentFixture<HrDocumentDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(HrDocumentDeleteDialog);
