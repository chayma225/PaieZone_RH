...
describe('ChatMessage Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a ChatMessage', () => {
      ...
      service.create(chatMessage).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a ChatMessage', () => {
      ...
      service.update(chatMessage).subscribe(resp => (expectedResult = resp));
    ...
    describe('addChatMessageToCollectionIfMissing', () => {
      it('should add a ChatMessage to an empty array', () => {
        ...
        expect(expectedResult).toEqual([chatMessage]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([chatMessage, chatMessage2]);
      });
