...
import { AccountingEntryDeleteDialog } from './accounting-entry-delete-dialog';

describe('AccountingEntry Management Delete Component', () => {
  let comp: AccountingEntryDeleteDialog;
  let fixture: ComponentFixture<AccountingEntryDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AccountingEntryDeleteDialog);
