...
import { CnssRateDeleteDialog } from './cnss-rate-delete-dialog';

describe('CnssRate Management Delete Component', () => {
  let comp: CnssRateDeleteDialog;
  let fixture: ComponentFixture<CnssRateDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CnssRateDeleteDialog);
