...
describe('CnssRate Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a CnssRate', () => {
      ...
      service.create(cnssRate).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a CnssRate', () => {
      ...
      service.update(cnssRate).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addCnssRateToCollectionIfMissing', () => {
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(cnssRate);
        expect(expectedResult).toContain(cnssRate2);
      });
