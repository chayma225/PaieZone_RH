...
import { KnowledgeDocumentDeleteDialog } from './knowledge-document-delete-dialog';

describe('KnowledgeDocument Management Delete Component', () => {
  let comp: KnowledgeDocumentDeleteDialog;
  let fixture: ComponentFixture<KnowledgeDocumentDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(KnowledgeDocumentDeleteDialog);
