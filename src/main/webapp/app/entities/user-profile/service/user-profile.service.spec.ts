...
describe('UserProfile Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a UserProfile', () => {
      ...
      service.create(userProfile).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a UserProfile', () => {
      ...
      service.update(userProfile).subscribe(resp => (expectedResult = resp));
    ...
    describe('addUserProfileToCollectionIfMissing', () => {
      it('should add a UserProfile to an empty array', () => {
        ...
        expect(expectedResult).toEqual([userProfile]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([userProfile, userProfile2]);
      });
