...
const requireRestSample: RestContract = {
  ...
  signedDate: sampleWithRequiredData.signedDate?.format(DATE_FORMAT),
...
describe('Contract Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Contract', () => {
      ...
      service.create(contract).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Contract', () => {
      ...
      service.update(contract).subscribe(resp => (expectedResult = resp));
