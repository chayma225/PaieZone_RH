...
public class Company implements Serializable {
    ...
    public void setSubscription(CompanySubscription companySubscription) {
        this.subscription = companySubscription;
    }

    public Company subscription(CompanySubscription companySubscription) {
        this.setSubscription(companySubscription);
        return this;
    }
