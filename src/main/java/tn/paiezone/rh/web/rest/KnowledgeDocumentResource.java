...
public class KnowledgeDocumentResource {
    ...
    /**
     * {@code GET  /knowledge-documents} : get all the Knowledge Documents.
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of Knowledge Documents in body.
     */
    @GetMapping("")
