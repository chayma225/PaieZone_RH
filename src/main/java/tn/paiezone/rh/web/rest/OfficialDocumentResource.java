...
public class OfficialDocumentResource {
    ...
    /**
     * {@code GET  /official-documents} : get all the officialDocuments.
     *
     * @param pageable the pagination information.
     * @param criteria the criteria which the requested entities should match.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of officialDocuments in body.
     */
    @GetMapping("")
