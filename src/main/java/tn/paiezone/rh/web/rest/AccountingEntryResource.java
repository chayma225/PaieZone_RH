...
public class AccountingEntryResource {
    ...
    /**
     * {@code GET  /accounting-entries} : get all the Accounting Entries.
     *
     * @param pageable the pagination information.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of Accounting Entries in body.
     */
    @GetMapping("")
