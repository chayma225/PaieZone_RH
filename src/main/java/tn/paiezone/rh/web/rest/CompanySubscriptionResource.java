...
public class CompanySubscriptionResource {
    ...
    /**
     * {@code GET  /company-subscriptions} : get all the companySubscriptions.
     *
     * @param filter the filter of the request.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of companySubscriptions in body.
     */
    @GetMapping("")
