...
public class RegulatoryParamResource {
    ...
    /**
     * {@code GET  /regulatory-params} : get all the Regulatory Params.
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of Regulatory Params in body.
     */
    @GetMapping("")
