...
public class CompanyDTO implements Serializable {
    ...
    public CompanySubscriptionDTO getSubscription() {
        return subscription;
    }

    public void setSubscription(CompanySubscriptionDTO subscription) {
